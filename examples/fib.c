...
static void __lambda_4(void *data, object clo, int argc, object *args) ;/*object self_7316, object r_7313*/
static void __lambda_5(void *data, object clo, int argc, object *args) ;/*object self_7317, object r_7312*/
static void __lambda_1(void *data, object clo, int argc, object *args) ;/*closure _,object k_735, object n_731_732*/
static void __lambda_2(void *data, object clo, int argc, object *args) ;/*object self_7314, object r_737*/
static void __lambda_3(void *data, object clo, int argc, object *args) ;/*object self_7315, object r_738*/

static void __lambda_4(void *data, object self_7316, int argc, object *args) /* object self_7316, object r_7313 */
 {
 object r_7313 = args[0];
  
mclosure0(c_7344, (function_type)__lambda_5);c_7344.num_args = 1;
return_direct_with_clo2(data,  __glo_write_scheme_write, (((closure)  __glo_write_scheme_write)->fn),  &c_7344, r_7313);; 
}

static void __lambda_5(void *data, object self_7317, int argc, object *args) /* object self_7317, object r_7312 */
 {
...
object k_735 = args[0]; object n_731_732 = args[1];
  Cyc_st_add(data, "examples/fib.scm:fib");
  
if( (boolean_f != Cyc_num_fast_lt_op(data, n_731_732, obj_int2obj(2))) ){ 
...
c_7323.elements = (object *)e_7337;
c_7323.elements[0] = k_735;
c_7323.elements[1] = n_731_732;


complex_num_type local_7340; 
return_direct_with_clo2(data,  __glo_fib, (((closure)  __glo_fib)->fn),  &c_7323, Cyc_fast_sub(data,&local_7340, n_731_732, obj_int2obj(2)));}
;; 
}

static void __lambda_2(void *data, object self_7314, int argc, object *args) /* object self_7314, object r_737 */
 {
 object r_737 = args[0];
...
c_7325.num_args = 1;
c_7325.num_elements = 2;
c_7325.elements = (object *)e_7332;
c_7325.elements[0] = ((closureN)self_7314)->elements[0];
c_7325.elements[1] = r_737;


complex_num_type local_7335; 
return_direct_with_clo2(data,  __glo_fib, (((closure)  __glo_fib)->fn),  &c_7325, Cyc_fast_sub(data,&local_7335, ((closureN)self_7314)->elements[1], obj_int2obj(1)));; 
}

static void __lambda_3(void *data, object self_7315, int argc, object *args) /* object self_7315, object r_738 */
 {
 object r_738 = args[0];
  
complex_num_type local_7330; 
return_direct_with_clo1(data,  ((closureN)self_7315)->elements[0], (((closure)  ((closureN)self_7315)->elements[0])->fn),  Cyc_fast_sum(data,&local_7330, ((closureN)self_7315)->elements[1], r_738));; 
}
...
Cyc_set_globals_changed((gc_thread_data *)data);
  ...
  add_global("__glo_fib", (object *) &__glo_fib);
  mclosure0(c_7318, (function_type)__lambda_1);c_7318.num_args = 1; 
  __glo_fib = &c_7318; 

  make_cvar(cvar_7349, (object *)&__glo_fib);make_pair(pair_7350, find_or_add_symbol("fib"), &cvar_7349);
make_pair(c_7351, &pair_7350,Cyc_global_variables);
Cyc_global_variables = &c_7351;
mclosure1(c_done, c_entry_pt_first_lambda, &c_done);
mclosure1(c_7352, c_schemewrite_entry_pt, &c_done);
mclosure1(c_7353, c_schemebase_entry_pt, &c_7352);
mclosure1(c_7354, c_schemecyclonecommon_entry_pt, &c_7353);
 object buf[1]; buf[0] = &c_7354; (c_7354.fn)(data, &c_7354, 1, buf);
}
static void c_entry_pt_first_lambda(void *data, object clo, int argc, object *args) {
  
    
mclosure0(c_7342, (function_type)__lambda_4);c_7342.num_args = 1;
return_direct_with_clo2(data,  __glo_fib, (((closure)  __glo_fib)->fn),  &c_7342, obj_int2obj(40));
;
}
